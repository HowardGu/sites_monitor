...
window.BMAP_AUTHENTIC_KEY = "xoDANekNHo3GGDppi8GfPd08hkuNSnCb"; (function() {
    ...
    function() {
        if (z.version && z.version >= 1.5) {
            ...
            q) : a.attachEvent && a.attachEvent("onreadystatechange",
            function() {
    ...
    x.extend(Ma.prototype, {
        ...
        mk: function(a, b, c, d) {
            ...
            if (c = c && d ? f.Hk(c, this.Sb) : this.dc) if (this.dc = new I(c.lng + a * e, c.lat - b * e), (a = f.rh(this.dc, this.Sb)) && g) this.re = a
        },
        Hg: function(a, b) {
        ...
        yi: function(a) {
            if (a instanceof N || a instanceof I) a = Za(a, this),
            this.dc = this.Ld.Hk(a, this.Sb),
            this.re = I.DE(a) ? new I(a.lng, a.lat) : this.Ld.rh(this.dc, this.Sb)
        },
        yg: function(a, b) {
            a = Math.round(a) || 0;
            b = Math.round(b) || 0;
        ...
        Eg: function(a) {
            if (this.xb !== a) {
                ...
                b.Na = c;
                b.xb = a;
                this.dispatchEvent(b); (a === ab || a === Ta) && Sa(ya)
            }
        },
        Wf: function(a) {
            var b = this;
            if (a instanceof N || a instanceof I) a = new I(Za(a, b).lng, Za(a, b).lat),
            b.yi(a, {
                noAnimation: o
            });
            else if (bb(a)) if (b.xb === Qa) {
                var c = G.uC[a];
                c && (pt = c.m, b.Wf(pt))
            } else {
                var d = this.ZH();
        ...
        Kp: function(a, b) {
            b = b || this.ga();
            if (a && (a instanceof N || a instanceof I)) return a = Za(a, this),
        ...
        jt: function(a, b) {
            ...
            for (var b = b || {},
            e = [], f = 0, g = d.length; f < g; f++) e.push(this.Ld.Hk(Za(d[f], this), this.Sb));
            d = new hb;
    ...
    function sc(a) {
        ...
        k = m.lng,
        m = m.lat;
        if (1.0E-6 >= xc(k, m, g, i)) return c.lng = d,
        c.lat = e,
        c;
        for (;;) {
            k = d - f;
            ...
            if (1.0E-6 > f) {
                a: {
                    ...
                    A = j;
                    for (O = 0; O <= c; O++) {
                        for (d = 0; d <= f; d++) if (A = b(j), J = j.lng * pc, u = j.lat * pc, l = A.lng * pc, A = A.lat * pc, !(l < k || A < s || l > m || A > B)) {
                            J -= l;
                            u -= A;
    ...
    function tc(a) {
        ...
        e = new yc,
        f = 0,
        d = 0; d < $b; ++d) bc[d] <= a.lat ? bc[(d + 1) % $b] > a.lat && 0 < Bc({
            lng: ac[d],
            lat: bc[d]
        },
        {
        ...
        a) && --f;
        if ((0 === f ? lc: mc) === lc) {
            for (f = 0; f < $b; ++f) if (d = new zc(ac[f], bc[f], ac[(f + 1) % $b], bc[(f + 1) % $b]), e.vg.lng = d.ky.vg.lng - 0.5, e.vg.lat = d.ky.vg.lat - 0.5, e.Dg.lng = d.ky.Dg.lng + 0.5, e.Dg.lat = d.ky.Dg.lat + 0.5, e.contains(a) !== lc) {
                var g;
                var i = d.mu.lng,
                k = d.mu.lat,
                l = d.qx.lng,
                m = d.qx.lat;
                g = m - k;
                var n = i - l; ! (Math.abs(g - 0) > nc) && !(Math.abs(n - 0) > nc) ? g = d.mu: (i = l * k - i * m, k = n * a.lng - g * a.lat, l = g * g - n * n, g = {
                    lng: (n * k - g * i) / l,
                    lat: -(g * k + n * i) / l
                });
                n = 180;
                    ...
                    e.RC == q && (e.RC = o, setTimeout(function() {
                        ...
                        if (a.length > 0) {
                            for (let i = 0; i < a.length; i++) {
                                let mf='./baidu/modules/'+a[i]+'.js'
                                qa(mf);
                                console.log('Loading module：' + mf) //IE error
                            }
                        } else {
                            e.mL();
                        }
    ...
    function kb(a, b) {
        a && (this.Kb = a, this.ba = "spot" + kb.ba++, b = b || {},
    ...
    x.extend(Ec.prototype, {
        ...
        Ie: function(a) { ! this.C && (this.initialize && $a(this.initialize)) && (this.C = this.initialize(a));
            this.k = this.k || {
                Cg: q
            };
            this.MB();
    ...
    x.extend(T.prototype, {
        ...
        zg: function(a, b, c, d, e) {
            ...
            this.rh(new I(c.lng + b * (a.x - d.width / 2), c.lat - b * (a.y - d.height / 2)), e)
        },
        yc: function(a) {
    ...
    x.extend($c.prototype, {
        ...
        initialize: function(a) {
            this.map = a;
            this.Mj();
            this.V && x.M(this.V, H() ? "touchstart": "mousedown",
            function(a) {
                na(a)
            });
            return this.V
    ...
    function cd(a, b, c, d) {
        a && (this.Nv = {},
        this.sL = d ? !!d: q, this.hd = [], this.Q_ = a instanceof bd ? a: p, this.YI = b === j ? o: !!(b.indexOf("%") + 1), this.ek = isNaN(parseFloat(b)) ? 1 : this.YI ? parseFloat(b) / 100 : parseFloat(b), this.ZI = !!(c.indexOf("%") + 1), this.repeat = c != j ? this.ZI ? parseFloat(c) / 100 : parseFloat(c) : 0)
    };
    function dd(a, b) {
        x.lang.Da.call(this);
        this.content = a;
    ...
    function jd(a, b) {
        var c = this;
        id() && (a === j && ca(Error("\u6ca1\u6709\u4f20\u5165points\u6570\u636e")), "[object Array]" !== Object.prototype.toString.call(a) && ca(Error("points\u6570\u636e\u4e0d\u662f\u6570\u7ec4")), b = b || {},
        ib.apply(c, arguments), c.ea = {
            ha: a
        },
        c.z = {
            shape: b.shape || gd,
        ...
        this.wB = [], this.pe = [], K.load("pointcollection",
        function() {
            for (var a = 0,
    ...
    x.extend(td.prototype, {
        ...
        gy: function() {
            ...
            this.loaded || a.Vx();
            a.Uf();
            this.loaded || (this.loaded = o, K.load("tile",
            function() {
                a.nQ()
            }))
        },
        ...
        F_: function(a, b, c, d) {
            ...
            k && k.Hb ? (yb(k.Hb, b), d && (d = new S(a[0], a[1]), f = this.map.B.ze ? this.map.B.ze.style: "normal", d = c.getTilesUrl(d, a[2], f), k.loaded = q, wd(k, d)), k.loaded ? this.zf() : xd(k,
            function() {
                e.zf()
            })) : (k = this.hj[g]) && k.Hb ? (c.Pb.insertBefore(k.Hb, c.Pb.lastChild), this.wg[g] = k, yb(k.Hb, b), d && (d = new S(a[0], a[1]), f = this.map.B.ze ? this.map.B.ze.style: "normal", d = c.getTilesUrl(d, a[2], f), k.loaded = q, wd(k, d)), k.loaded ? this.zf() : xd(k,
            function() {
                e.zf()
            })) : (k = i * Math.pow(2, f.Bm() - a[2]), new I(a[0] * k, a[1] * k), d = new S(a[0], a[1]), f = this.map.B.ze ? this.map.B.ze.style: "normal", d = c.getTilesUrl(d, a[2], f), k = new yd(this, d, b, a, c), xd(k,
            function() {
                e.zf()
            }), k.ko(), this.wg[g] = k)
        },
        ...
        Uf: function(a) {
            var b = this;
            if (b.map.oa() == Qa) K.load("coordtrans",
            function() {
    ...
    yd.prototype.ko = function() {
        this.Hb.src = 0 < x.da.ma && 6 >= x.da.ma && this.HJ ? G.qa + "blank.gif": "" !== this.src && this.Hb.src == this.src ? this.src + "&t = " + Date.now() : this.src
    };
    function vd(a) {
    ...
    function Pa(a, b) {
        ...
        var e = this;
        this.ko = function() {
            this.hk === "flashRender" ? K.load("panoramaflash",
            function() {
                e.Ti()
            },
            o) : K.load("panorama",
    ...
    x.extend(Pa.prototype, {
        ...
        KB: function() {
            if (this.D) for (var a = this.D.Ix(), b = 0; b < a.length; b++)(a[b] instanceof V || a[b] instanceof ed) && a[b].point && this.wa.push(a[b])
        },
        Ny: da("D"),
        cu: function(a) {
            this.Nf = a || "none"
    ...
    x.extend(Oc.prototype, {
        ca: function() {
            ...
            function() {
                c.Ug(Oc.il + "qt=idata&iid=" + b.HA + "&fn=",
                function(b) {
    ...
    x.extend(Re, {
        ...
        OL: function(a, b, c, d, e) {
            ...
            return (Re.Ou + "?qt=pr3d&fovy=75&quality=80&panoid={panoId}&heading={panoHeading}&pitch={panoPitch}&width={width}&height={height}").replace(/\{(.*?)\}/g,
            function(a, b) {
                return f[b]
            })
        }
    ...
    Ve;
    a: {
        for (var We = ["t", "webkitT", "MozT", "msT", "OT"], Xe, Ye = 0, Ze = We.length; Ye < Ze; Ye++) if (Xe = We[Ye] + "ransform", Xe in Ue) {
    ...
    uf = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame ||
    function(a) {
    ...
    function xf(a, b) {
        ...
        c.refresh();
        c.ca(of, window);
        c.ca(pf); ! lf && "none" != c.options.lP && (c.ca("DOMMouseScroll"), c.ca("mousewheel"));
    ...
    xf.prototype = {
        ...
        $v: function(a) {
            ...
            if (this.enabled) {
                ...
                if (this.options.ly && (this.options.$k ? (c = getComputedStyle(this.Nb, p)[bf].replace(/[^0-9\-.,]/g, "").split(","), d = +(c[12] || c[4]), c = +(c[13] || c[5])) : (d = +getComputedStyle(this.Nb, p).left.replace(/[^0-9-]/g, ""), c = +getComputedStyle(this.Nb, p).top.replace(/[^0-9-]/g, "")), d != this.x || c != this.y)) this.options.Ei ? this.$d(tf) : vf(this.jC),
                this.Ej = [],
                this.Ir(d, c),
        ...
        tT: function(a) {
            ...
            if (this.options.zoom && lf && 1 < a.touches.length) e = Te.abs(a.touches[0].pageX - a.touches[1].pageX),
            ...
            this.Nb.style[bf] = "translate(" + e + "px," + f + "px) scale(" + b + ")" + wf,
        ...
        lv: function(a) {
            if (! (lf && 0 !== a.touches.length)) {
                ...
                b.Nb.style[df] = "200ms",
                b.Nb.style[bf] = "translate(" + b.x + "px," + b.y + "px) scale(" + b.scale + ")" + wf,
                b.cl = q,
                b.refresh(),
                b.options.Gp && b.options.Gp.call(b, a);
                    ...
                    if (b.th) {
                        ...
                        if (lf) if (b.WK && b.options.zoom) clearTimeout(b.WK),
                        b.WK = p,
        ...
        ro: function(a) {
            ...
            if (b == this.x && c == this.y) {
                if (this.th && (this.th = q, this.options.ty && this.options.ty.call(this)), this.qi && this.options.Rx && ("webkit" == Ve && (this.eM.style[gf] = "300ms"), this.eM.style.opacity = "0"), this.Fi && this.options.Rx)"webkit" == Ve && (this.dP.style[gf] = "300ms"),
        ...
        Fy: function(a, b) {
            if (b || !this.fk[this.Xc] || !(this.fk[this.Xc].panoId == a && 3 !== this.fk[this.Xc].recoType)) {
                ...
                d = this.UH(a); ! b && -1 !== d && this.fk[d] && 3 !== this.fk[d].recoType ? this.Wp(d) : this.RX(function(a) {
                    ...
                    i = a[m].floor,
                    j !== d && ("" === d && j !== i ? (k = o, b[i] || (b[i] = []), b[i].push(a[m])) : (b[Af[d]] || (b[Af[d]] = []), b[Af[d]].push(a[m])));
